...
entity houghlines_accel_addrbound is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of houghlines_accel_addrbound is 
...
attribute shreg_extract : string;
    ...
    signal grp_fu_81_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal return_r_preg : STD_LOGIC_VECTOR (18 downto 0) := "0000000000000000000";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sext_ln996_fu_69_p0 : STD_LOGIC_VECTOR (5 downto 0);
    signal sext_ln996_fu_69_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_81_p0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_fu_81_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_81_ce : STD_LOGIC;
    signal ap_NS_fsm : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_fu_81_p00 : STD_LOGIC_VECTOR (18 downto 0);
    signal grp_fu_81_p10 : STD_LOGIC_VECTOR (18 downto 0);
...
begin
    ...
    grp_fu_81_ce_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, rows_empty_n, cols_empty_n, rows_out_full_n, cols_out_full_n)
    begin
    ...
    grp_fu_81_p0 <= grp_fu_81_p00(10 - 1 downto 0);
    grp_fu_81_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(cols_dout),19));
    grp_fu_81_p1 <= grp_fu_81_p10(9 - 1 downto 0);
    grp_fu_81_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln996_fu_69_p1),19));

    return_r_assign_proc : process(grp_fu_81_p2, return_r_preg, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            return_r <= grp_fu_81_p2;
        else 
    ...
    sext_ln996_fu_69_p0 <= rows_dout;
        sext_ln996_fu_69_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln996_fu_69_p0),9));
