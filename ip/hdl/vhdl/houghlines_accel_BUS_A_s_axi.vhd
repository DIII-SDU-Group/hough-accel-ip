...
architecture behave of houghlines_accel_BUS_A_s_axi is
    ...
    constant ADDR_THETA_ARRAY_DATA_0 : INTEGER := 16#18#;
    constant ADDR_THETA_ARRAY_CTRL   : INTEGER := 16#1c#;
    ...
    signal int_img_in          : UNSIGNED(7 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IMG_IN_DATA_0 =>
                        rdata_data <= RESIZE(int_img_in(7 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_IN_DATA_0) then
                    int_img_in(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_img_in(7 downto 0));
                end if;
            end if;
        end if;
    end process;
